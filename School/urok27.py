...
chars = len(text)
spaces = text.count(" ") + text.count("\t") + text.count("\n")
words = len(text.split())

print("\n\n")
print(" Broi simvoli (vkl. raztoqniq): " + str(chars))
print(" Broi simvoli (bez raztoqniq): " + str(chars-spaces))
print("Broi dumi: " + str(words))
print("\n\n")

if words > 300 and chars > 1500
    print("Tekstut otgovarq na vsichki iziskaniq na bori dumi i simvoli.")